...
\end{align}
where $\mathfrak{S}_{N}$ is a symmetric group of degree $N$ and $( \overline{\bm{R}}, \overline{\bm{v}} )_{\bm{A}} \coloneqq ( \bm{A}\overline{\bm{R}}\bm{A}^{-1}, \bm{A}\overline{\bm{v}} )$.
...
\begin{align}
  \mathcal{T}_{\bm{A}_{\mathcal{S}}}
    &= \bigsqcup_{ \overline{ \bm{t} }^{\mathcal{S}} }
      ...
      \mathcal{T}_{\bm{A}} \\
  \mathcal{S}
    &= \bigsqcup_{ \overline{\bm{R}}^{\mathcal{S}} } \bigsqcup_{ \overline{ \bm{t} }^{\mathcal{S}} }
      \left(
...
\begin{align}
  \mathcal{T}_{\bm{A}_{\mathcal{D}}}
    &= \set{
      ...
      \times \mathcal{T}_{\bm{A}_{\mathcal{S}}}.
\end{align}
Then, we take one of primitive basis vectors $\bm{A}_{\mathcal{D}}$ of with
\begin{align}
  \bm{A}
    &= \bm{A}_{\mathcal{D}} \bm{V} \quad (\bm{V} \in \mathbb{Z}^{3 \times 3}) \\
  \mathcal{T}_{\bm{A}_{\mathcal{D}}}
    &= \bigsqcup_{ \overline{ \bm{t} }^{\mathcal{D}} }
      \left( \bm{E}, \overline{ \bm{t} }^{\mathcal{D}} \right)_{ \bm{A}_{\mathcal{D}} }
      \mathcal{T}_{\bm{A}}.
\end{align}

\begin{align}
  \mathcal{S}
    &\neq \bigsqcup_{ \overline{\bm{R}}^{\mathcal{S}} } \bigsqcup_{ \overline{ \bm{t} }^{\mathcal{D}} }
      \left(
        \bm{V}^{-1} \overline{\bm{R}}^{\mathcal{S}} \bm{V},
        \bm{V}^{-1} \overline{ \bm{v} }^{\mathcal{S}}(\overline{\bm{R}}^{\mathcal{S}})
      \right)_{ \bm{A}_{\mathcal{D}} }
      \left( \bm{E}, \overline{ \bm{t} }^{\mathcal{D}} \right)_{ \bm{A}_{\mathcal{D}} }
      \mathcal{T}_{\bm{A}},
\end{align}

For coset representatives $(\bm{E}, \bm{A}_{\mathcal{D}} \overline{ \bm{t} }^{\mathcal{D}})$, we search for $\bm{W}_{\bm{v}}$ by solving a Procrustes problem as shown in Appendix~\ref{appx:procrustes}.
