...
POINT_GROUP_GENERATORS = {
    ...
    "-4": [2],  # -4^+
    "4/m": [2, 5],  # 4^+, m
    "422": [2, 4, 6],  # 4^+, 2_010, 2_110
    "4mm": [2, 4, 6],  # 4^+, m_010, m_110
    "-42m": [2, 4, 6],  # -4^+, 2_010, m_110
    "4/mmm": [2, 9, 12, 14],  # 4^+, m_001, m_010, m_110
    ...
    "-6": [5],  # -6^+
    "6/m": [5, 9],  # 6^+, m
    "622": [5, 6, 10],  # 6^+, 2_110, 2_120
    "6mm": [5, 6, 10],  # 6^+, m_110, m_120
    "-6m2": [5, 6, 10],  # -6^+, m_110, 2_120
    "6/mmm": [5, 15, 18, 22],  # 6^+, m_001, m_110, m_120
    # Cubic: [100]/[010]/[010] [111]/[1-1-1]/[-11-1]/[-1-11] [1-10]/[110]/[01-1]/[011]/[-101]/[101]
    "23": [1, 4],  # 2_001, 3^+
    "m-3": [13, 16],  # m_001, -3^+_111
    "432": [15, 4, 12],  # 4^+_001, 3^+_111, 2_110
    "-43m": [14, 4, 12],  # -4^+_001, 3^+_111, m_1-10
    "m-3m": [25, 28, 36],  # m_001, -3^+_111, m_110
}
...
SPIN_POINT_GROUP_TYPES = {
    ...
    "-6m2": {
        ...
        "1": {
            ...
            "6mm": [(437, [5, 7, 11])],
            "-6m2": [(438, [5, 7, 11]), (439, [5, 11, 6])],  # Corrected(439): -6, 2_210, m_xy
        },
    },
    "6/mmm": {
        "6/mmm": {
        ...
        "m": {
            ...
            "-3m": [(521, [7, 0, 10, 3])],
            "6mm": [(522, [5, 0, 7, 11])],
            "-6m2": [(523, [5, 0, 11, 6])],  # Corrected(523): -6, 1, 2_210, m_xy
        },
        "2": {
            "622": [
                (524, [1, 3, 7, 6]),
            ...
            "-6m2": [
                (528, [1, 3, 7, 6]),
                (529, [1, 3, 9, 11]),  # Corrected(529): 3, m_z, 2_xy, 2_210
            ],
        },
        "1": {
            "6/mmm": [
    ...
    "m-3m": {
        ...
        "1": {
            "m-3m": [(597, [25, 28, 36]), (598, [25, 28, 12])],
        },
    },
}
